...
public class X10cm15AlloffCommand implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            ps.println("allloff"); // ej en el caso de que queramos encender el módulo.
            ps.flush(); // debido a que pulsamos un intro al introducir un caracter
