...
public class X10cm15DimmerCommand implements Runnable {
    private String address;

    public X10cm15DimmerCommand() {
        this.address = "No se ha recibido ninguna dirección";
    }

    public X10cm15DimmerCommand(String address) {
    ...
    public void run() {
        ...
        try {
            ...
            ps.flush();
            ps.println(address + " dim on"); // CAMBIAR A DIMMER
