...
public class X10cm15PercentCommand implements Runnable {
    private String address;
    private int level;

    public X10cm15PercentCommand() {
        this.address = "No se ha recibido ninguna dirección";
    }

    public X10cm15PercentCommand(String address, int level) {
    ...
    public void run() {
        ...
        try {
            ...
            ps.flush();
            ps.println(address + " dim " + level); // CAMBIAR A DIMMER
