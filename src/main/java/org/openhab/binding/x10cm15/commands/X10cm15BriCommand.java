...
public class X10cm15BriCommand implements Runnable {
    private String address;

    public X10cm15BriCommand() {
        this.address = "No se ha recibido ninguna dirección";
    }

    public X10cm15BriCommand(String address) {
    ...
    public void run() {
        ...
        try {
            ...
            ps.flush();
            ps.println(address + " Bri 15%"); // CAMBIAR A DIMMER
